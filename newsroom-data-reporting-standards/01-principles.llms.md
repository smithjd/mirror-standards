...
## 1 P-1 The message comes first (MUST)
...
## 2 P-2 Titles state the finding (SHOULD)
...
## 3 P-3 Show the data honestly (MUST)
...
## 4 P-4 Maximize data, minimize decoration (SHOULD)
...
## 5 P-5 Less, but comparable (SHOULD)
...
## 6 P-6 Consistency across the publication (MUST)
...
## 7 P-7 Every chart cites its source (MUST)
...
## 8 P-8 Design for the reader you don’t control (MUST)
...
- Every chart MUST have a text alternative (alt text, a data table, or descriptive prose).
