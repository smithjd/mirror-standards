...
noted. Hex codes in [03-color-palettes.qmd](03-color-palettes.qmd) trace to the starred
(★) primary sources.
...
- ★ **Visual Vocabulary** — Financial-Times/chart-doctor, `visual-vocabulary/`,
  ...
  The normative chart-type taxonomy in [02-chart-types.qmd](02-chart-types.qmd): nine
